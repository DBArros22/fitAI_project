...
const dicionarioExercicios = {
    "Peitoral": [
        ...
        "Supino Inclinado com Halteres em Rotação Neutra", "Supino Inclinado com Pausa",
        ...
        "Chest Press Inclinado (Máquina)", "Chest Press Inclinado Unilateral", "Chest Press Declinado (Máquina)",
        "Peck Deck (Voador Clássico)", "Peck Deck Inclinado", "Peck Deck com Braços Estendidos", "Peck Deck Unilateral",
        "Crucifixo Reto (Halteres)", "Crucifixo Inclinado (Halteres)", "Crucifixo Declinado (Halteres)", 
        "Crucifixo Reto com Rotação", "Crucifixo com Halteres no Banco 30", "Crucifixo com Halteres no Banco 45",
        "Crucifixo Reto (Cabo)", "Crucifixo Inclinado (Cabo)", "Crucifixo Declinado (Cabo)", 
        "Crucifixo na Máquina Articulada", "Crucifixo no Cabo em Pé (Low to High)", "Crucifixo no Cabo (High to Low)",
        "Crossover Polia Alta (Foco Inferior)", "Crossover Polia Baixa (Foco Superior)", 
        "Crossover Polia Média (Foco Medial)", "Crossover Unilateral em Pé", "Crossover com Passada à Frente",
        "Dips (Paralelas Foco em Peito)", "Dips (Paralelas) Assistido no Graviton", "Dips com Carga (Cinturão)",
        ...
        "Flexão com Deslocamento Lateral", "Flexão Arqueiro", "Flexão com Palmas", "Flexão com Colete de Peso",
        "Pull-over (Halter)", "Pull-over (Barra Reta)", "Pull-over na Polia Alta", "Pull-over na Máquina",
        "Press Around Unilateral (Cabo)", "Floor Press (Supino no Chão com Halteres)", 
        "Squeeze Press (Halteres Juntos)", "Landmine Chest Press (Barra Guiada no Canto)", "Svend Press com Anilhas"
    ],
    "Dorsais": [
        ...
        "Puxada com Barra Reta (Braços Estendidos)", "Puxada com Corda na Polia Alta",
        ...
        "Remada Baixa Romana (Pegada Neutra)", "Remada Baixa Unilateral", "Remada Baixa com Corda",
        ...
        "Remada Meadows (Unilateral com Barra Livre)", "Remada Invertida (Peso Corporal na Barra)",
        ...
        "Crucifixo Inverso (Cabo)", "Crucifixo Inverso (Peck Deck/Voador Inverso)",
        "Face Pull (Corda na Polia Alta)", "Face Pull com Rotação Externa Alta",
        "Hyperextension (Extensão Lombar Banco 45)", "Extensão Lombar no Solo (Super-homem)"
    ],
    "Trapézio": [
        ...
        "Encolhimento Unilateral (Halter)", "Encolhimento com Pausa de 2 Segundos",
        "Remada Alta Aberta (Barra)", "Remada Alta Aberta (Cabo)", "Remada Alta Fechada",
        "Crucifixo Inverso Y (Halteres)", "Elevação em Y na Polia Baixa", "Farmer's Walk (Caminhada do Fazendeiro)"
    ],
    "Deltoides (Ombros)": [
        ...
        "Elevação Lateral na Máquina", "Elevação Lateral Inclinada (Banco 45 de Lado)", "Elevação Lateral Y",
        ...
        "Elevação Frontal (Cabo com Corda)", "Elevação Frontal com Anilha",
        "Crucifixo Inverso (Halteres Sentado/Inclinado)", "Crucifixo Inverso na Polia Alta", "Face Pull com Corda"
    ],
    "Quadríceps": [
        "Agachamento Livre (Barra Costas)", "Agachamento Livre (Barra Frente - Front Squat)", 
        "Agachamento Smith (Barra Guiada)", "Agachamento Smith com Pés Avançados",
        "Agachamento Hack (Linear)", "Agachamento Hack Invertido", "Agachamento Hack Unilateral",
        "Leg Press 45 Tradicional", "Leg Press 45 Unilateral", "Leg Press 45 com Pés Baixos", 
        ...
        "Agachamento Búlgaro (Halteres)", "Agachamento Búlgaro (Barra)", "Agachamento Búlgaro no Smith", "Agachamento Búlgaro com Deficit",
        "Afundo com Halteres", "Afundo com Barra Costas", "Afundo no Smith", "Afundo Reverso",
        "Passada Dinâmica (Walking Lunges com Halteres)", "Passada Dinâmica (Barra)", "Passada no Lugar",
        "Goblet Squat (Halter)", "Goblet Squat (Kettlebell)", "Sissy Squat Livre", "Sissy Squat na Máquina",
        "Agachamento Belt Squat", "Agachamento Sumô (Halter)", "Agachamento Zercher (Barra)",
        "Subida no Banco (Step-up com Halteres)", "Agachamento Pistol"
    ],
    "Posteriores de Coxa": [
    ...
    "Glúteos": [
        ...
        "Elevação Pélvica Unilateral", "Elevação Pélvica com Elástico (Mini-band)",
        "Glúteo Coice Cruzado (Cabo)", "Glúteo Coice Reto (Cabo)", "Glúteo Coice na Máquina Articulada", 
        "Glúteo Quatro Apoios (Caneleira Joelho Flexionado)", "Glúteo Quatro Apoios (Caneleira Perna Estendida)",
        "Abdução de Quadril (Máquina Sentado)", "Abdução de Quadril (Máquina Inclinado para Frente)", 
        "Abdução no Cabo/Polia Baixa", "Abdução de Quadril em Pé (Caneleira)", "Abdução de Quadril (Elástico Mini-band)",
        "Extensão de Quadril (Banco Romano)", "Frog Pump", "Kettlebell Swing"
    ],
    "Bíceps/Braquial": [
        ...
        "Rosca Martelo Alternada", "Rosca Martelo Cruzada",
        ...
        "Rosca 21 (Barra EZ)", "Rosca Spider (De bruços no Banco Inclinado)", "Rosca Drag (Barra Rastejando pelo Corpo)"
    ],
    "Tríceps Braquial": [
        "Tríceps Pulley / Barra Reta (Polia Alta)", "Tríceps Pulley / Barra V (Polia Alta)", 
        "Tríceps Pulley / Corda (Polia Alta)", "Tríceps Pulley Unilateral (Pegada Inversa/Supinada)", "Tríceps Pulley Unilateral (Pegada Pronada)",
        "Tríceps Testa (Barra W)", "Tríceps Testa (Barra Reta)", "Tríceps Testa (Halteres)", "Tríceps Testa (Cabo/Polia)", "Tríceps Testa Inclinado",
        "Tríceps Francês (Halter - Duas Mãos Sentado)", "Tríceps Francês Unilateral (Halter Sentado)", 
        "Tríceps Francês Unilateral (Halter em Pé)", "Tríceps Francês (Corda na Polia Baixa)", "Tríceps Francês (Barra W)",
        ...
        "Flexão de Braço Fechada (Diamante)", "Flexão de Braço Archer", "Tríceps Extensão Corporal"
    ],
    "Antebraço": [
    ...
    "Core/Abdominal": [
        ...
        "Abdominal Supra na Máquina", "Abdominal Supra com Carga", "Abdominal Supra na Polia (Ajoelhado com Corda)",
        ...
        "Elevação de Pernas nas Paralelas", "Elevação de Joelhos nas Paralelas",
        "Prancha Isométrica Frontal (Cotovelos)", "Prancha Isométrica Frontal (Braços Estendidos)", 
        "Prancha Lateral (Cotovelo)", "Prancha Lateral com Elevação de Quadril", "Prancha Dinâmica",
        "Ab Wheel (Roda Abdominal de Joelhos)", "Ab Wheel (Roda Abdominal em Pé)",
        "Russian Twist (Giro Russo sem Carga)", "Russian Twist com Carga",
        "Stomach Vacuum (Vácuo Abdominal LPF)", "Abdominal Oblíquo Solo", "Abdominal Oblíquo Toque nos Calcanhares", "Abdominal Oblíquo na Polia Alta",
        "Abdominal Canivete Bilateral (V-up)", "Abdominal Canivete Unilateral", "Abdominal Bicicleta (Air Bike Crunch)", 
        "Flexão Lateral de Tronco (Halter em Pé)", "Flexão Lateral de Tronco (Banco Romano)"
    ],
    "Panturrilhas": [
        ...
        "Panturrilha no Smith (Com Bloco/Step nos Pés)", "Panturrilha em Pé Livre (Solo)", 
        "Panturrilha Sentado com Barra Livre nas Coxas", "Tíbial Anterior (Elevação dos Dedos do Pé)"
    ],
    "Cardio & Aeróbico": [
