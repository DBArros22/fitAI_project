...
>>>>>>> 9f984a5361fbb914a8b408acdbc377e2785abb7a
    modalEl.innerHTML = `
<<<<<<< HEAD
...
<<<<<<< HEAD
        <div id="lista-notificacoes-conteudo" style="max-height: 320px; overflow-y: auto;">
            <p style="color: #64748b; text-align: center; font-size: 12px; padding: 20px;">Carregando...</p>
=======
        <div id="lista-notificacoes-conteudo" style="max-height: 320px; overflow-y: auto;">
        ...
        snapshot.forEach(doc => {
            ...
            itensHtml += `
                <div style="display: flex; align-items: center; gap: 12px; padding: 10px 12px; border-bottom: 1px solid rgba(255,255,255,0.06); transition: background 0.2s;" onmouseover="this.style.background='rgba(255,255,255,0.04)'" onmouseout="this.style.background='transparent'">
                    ...
                    ${linkId && tipo !== 'seguir' ? `
                        <button type="button" onclick="clicarNotificacao('${tipo}', '${linkId}', '${remetenteUid}')" style="background: rgba(59,130,246,0.15); border: 1px solid rgba(59,130,246,0.3); color: #3b82f6; padding: 4px 8px; border-radius: 6px; font-size: 10px; cursor: pointer; font-weight: bold; white-space: nowrap;">Ver Post</button>
                    ` : ''}
                </div>
            `;
        });

        const container = document.getElementById('lista-notificacoes-conteudo');
        if (container) {
            container.innerHTML = itensHtml || '<p style="color: #64748b; text-align: center; font-size: 12px; padding: 20px;">Nenhuma notificação recente.</p>';
        }
    } catch (err) {
        console.error("Erro ao carregar notificações:", err);
        const container = document.getElementById('lista-notificacoes-conteudo');
        if (container) {
            container.innerHTML = '<p style="color: #ef4444; text-align: center; font-size: 12px; padding: 20px;">Erro ao carregar.</p>';
        }
    }
=======
